...
if __name__ == "__main__":
    ...
    train_motion, train_ctrl = import_and_slice(train_files, motion_path, speech_path, None, slice_win_train, window_overlap, mirror=False)
    val_motion, val_ctrl = import_and_slice(held_out, motion_path, speech_path, None, slice_win_train, window_overlap, mirror=False, start=0, end=val_test_split)
    ...
    dev_motion, dev_ctrl = import_and_slice(held_out, motion_path, speech_path, None, slice_win_test, 0, mirror=False, start=0, end=val_test_split)
    test_motion, test_ctrl = import_and_slice(held_out, motion_path, speech_path, None, slice_win_test, 0, mirror=False, start=val_test_split)
